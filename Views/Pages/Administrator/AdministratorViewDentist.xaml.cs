...
namespace QuanLyNhaKhoa.Views.Pages.Administrator
{
    ...
    /// </summary>
    public sealed partial class AdministratorViewDentist : Page
    {
        internal DentistListViewModel DentistList { get; set; } = new();
        ...
        public AdministratorViewDentist()
        {
        ...
        private void ListView_SelectionChanged(object sender, Microsoft.UI.Xaml.Controls.SelectionChangedEventArgs e)
        {
            ...
            {
                bool isLocked = DentistList.DentistList[(sender as ListView).SelectedIndex].Status;
        ...
        private void Remove_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                bool isLocked = DentistList.DentistList[(RecListView).SelectedIndex].Status;
                DentistList.LockOrUnlock(RecListView.SelectedIndex);
                LockContent.Visibility = isLocked ? Visibility.Visible : Visibility.Collapsed;
                UnLockContent.Visibility = isLocked ? Visibility.Collapsed : Visibility.Visible;
            }
        }
        ...
        private async void PerfomingQuery(AutoSuggestBox sender)
        {
            ...
            await DentistList.UpdateSource(textSearch);
